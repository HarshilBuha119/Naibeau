...
export default function CartScreen() {
  ...
  const masterCart = response?.data?.masterCart || { service_sub_total: "0.00" };
        ...
        ListFooterComponent={cartItems.length > 0 ? (
          <View style={styles.summaryCard}>
            ...
            <View style={styles.summaryRow}>
              ...
              <Text style={styles.summaryValue}>₹{masterCart.service_sub_total}</Text>
            </View>
            <View style={styles.summaryRow}>
            ...
            <View style={styles.summaryRow}>
              ...
              <Text style={styles.totalValue}>₹{masterCart.service_sub_total}</Text>
            </View>
          </View>
        ) : null}
      />
      ...
      {cartItems.length > 0 && (
        <View style={styles.bottomBar}>
          <View>
            ...
            <Text style={styles.bottomPriceValue}>₹{masterCart.service_sub_total}</Text>
          </View>
          <TouchableOpacity 
...
const styles = StyleSheet.create({
  ...
  itemCountBadge: { backgroundColor: '#E0F2FE', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 10 },
  itemCountText: { color: '#0284C7', fontSize: 12, fontWeight: '800' },
  listPadding: { paddingHorizontal: 20, paddingBottom: 120 },
  retryBtn: { marginTop: 10, padding: 10, backgroundColor: '#1A1D1E', borderRadius: 8 },
  retryText: { color: '#FFF' },
  summaryCard: { backgroundColor: '#FFF', borderRadius: 24, padding: 20, marginTop: 10 },
  summaryTitle: { fontSize: 16, fontWeight: '800', color: '#1A1D1E', marginBottom: 15 },
  summaryRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 12 },
  summaryLabel: { fontSize: 14, color: '#64748B', fontWeight: '500' },
  summaryValue: { fontSize: 14, color: '#1A1D1E', fontWeight: '700' },
  dashedLine: { height: 1, borderStyle: 'dashed', borderWidth: 1, borderColor: '#E2E8F0', marginVertical: 10 },
  totalLabel: { fontSize: 16, fontWeight: '800', color: '#1A1D1E' },
  totalValue: { fontSize: 18, fontWeight: '900', color: '#4F46E5' },
  bottomBar: { position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: '#FFF', paddingHorizontal: 25, paddingVertical: 20, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderTopLeftRadius: 30, borderTopRightRadius: 30, elevation: 20, shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 20 },
  bottomPriceLabel: { fontSize: 12, color: '#64748B', fontWeight: '600' },
  bottomPriceValue: { fontSize: 20, fontWeight: '900', color: '#1A1D1E' },
  checkoutBtn: { backgroundColor: '#1A1D1E', flexDirection: 'row', alignItems: 'center', paddingHorizontal: 25, paddingVertical: 15, borderRadius: 18, gap: 8 },
  checkoutText: { color: '#FFF', fontSize: 16, fontWeight: '800' },
  emptyContainer: { alignItems: 'center', marginTop: 100 },
  emptyTitle: { fontSize: 20, fontWeight: '900', color: '#1A1D1E', marginTop: 20 },
  emptySub: { fontSize: 14, color: '#64748B', textAlign: 'center', marginTop: 10, paddingHorizontal: 40 }
});